...
const uploadCoudinary = require("../middlewares/cloudinaryHelper");
...
const createBlogController = async (req, res) => {
  try {
    ...
    const uploadResult = await uploadCoudinary(req?.file?.path);
...
const updateBlogController = async (req, res) => {
  ...
  try {
    ...
    if (req.file) {
      ...
      const uploadResult = await uploadCoudinary(
        req?.file?.path,
